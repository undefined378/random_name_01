...
<p align="center"><strong>(a) Convection + ALM</strong> &emsp;&emsp;&emsp; <strong>(b) Convection + L-BFGS</strong></p>
...
<p align="center"><strong>(c) Convection + NNCG</strong> &emsp;&emsp;&emsp; <strong>(d) RoPINN</strong></p>
...
<p align="center"><strong>(e) Reaction + L-BFGS</strong> &emsp;&emsp;&emsp; <strong>(f) Wave + L-BFGS</strong></p>
...
<p align="center"><strong>(g) AD-FNO</strong> &emsp;&emsp;&emsp; <strong>(h) Poisson-FNO</strong></p>
...
<p align="center"><strong>(a) Training Loss (Adam - SOAP)</strong> &emsp;&emsp;&emsp; <strong>(b) Test Error (Adam - SOAP)</strong></p>
...
<p align="center"><strong>(c) Training Loss (Adam - RoPINN)</strong> &emsp;&emsp;&emsp; <strong>(d) Test Error (Adam - RoPINN)</strong></p>
...
<p align="center"><strong>(a) Training Loss</strong> &emsp;&emsp;&emsp; <strong>(b) Test Error</strong></p>
